...
1. What problem does the context API help solve?
   ...
   -It allows us to link state directly where we need it more easily than prop drilling.

2. In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

   -ACTIONS are functions that return an object with or without some data. They come with a TYPE property which is a name for what needs to be done, and a PAYLOAD property to sometimes hold data.
   -REDUCERS retrieve the objects returned from the ACTIONS, and change state in the STORE if the ACTION properties matches a cases within the REDUCER.
   -The STORE is main source of state for the application. It contains state that needs to be distributed amongst most of the app.

   -It's known as a 'single source of truth' within a redux application because this is where the main state should be held. Once an application grows, redux helps the creator by holding state in a designated place making it easier to distribute within an app.

3. What does `redux-thunk` allow us to do? How does it change our `action-creators`?

   -Thunk allows us to make asynchronous actions.

4. What is your favorite state management system you've learned and this sprint? Please explain why!

   -Redux because I never understood it. I never seen the point to it because I didn't understand it, I never knew why people dreaded working with it, and I never seen any practical use to it because all the apps I would work on were small. Now that I understand it more, I can see it's usefulness in larger applications. I can also see how tideous the process is and understand why people talk smack on it so much.
